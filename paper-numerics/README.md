...
* [analyseLgEstimates.sh](analyseLgEstimates.jl): Julia script that generates the plots in the paper from the output after running the commands generated by the three shell scripts above
