...
struct CCSMCIO{Particle, ParticleScratch}
  ...
  bws1::Vector{Float64}
  bws2::Vector{Float64}
  # previous log-weights (for pariwise potentials)
  prevLws1::Vector{Float64}
  prevLws2::Vector{Float64}
end
...
function CCSMCIO{Particle, ParticleScratch}(N::Int64, n::Int64) where
  ...
  prevLws1 = Vector{Float64}(undef, N)
  prevLws2 = Vector{Float64}(undef, N)

  return CCSMCIO{Particle, ParticleScratch}(N, n, smcio1, smcio2, ref1, ref2,
    nws1, nws2, cws, rws1, rws2, bws1, bws2, prevLws1, prevLws2)
end
